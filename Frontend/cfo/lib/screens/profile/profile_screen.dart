    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Profile', style: TextStyle(
          fontSize: 16, fontWeight: FontWeight.w700, color: AppTheme.onSurfaceText(context),
        )),
      ),
      body: ListView(
      ...
      _infoCard(context, [
        _infoRow(context,Icons.business_rounded, 'Company', company['name'] ?? 'N/A'),
              _infoRow(context,Icons.category_rounded, 'Industry', company['industry'] ?? 'N/A'),
              ...
              _infoRow(context,Icons.people_rounded, 'Employees', '${company['employees'] ?? 0}'),
            ]),
          ],

          if (role == 'advisor') ...[
            _sectionHeader('ADVISOR INFO'),
            const SizedBox(height: 8),
            _infoCard(context, [
              _infoRow(context,Icons.star_rounded, 'Rating', '4.9'),
              _infoRow(context,Icons.people_rounded, 'Total Clients', '8'),
              _infoRow(context,Icons.calendar_month_rounded, 'Active Engagements', '5'),
              _infoRow(context,Icons.check_circle_rounded, 'Completed Sessions', '47'),
            ]),
          ],

          if (role == 'admin') ...[
            _sectionHeader('PLATFORM OVERVIEW'),
            const SizedBox(height: 8),
            _infoCard(context, [
              _infoRow(context,Icons.people_rounded, 'Total Founders', '342'),
              _infoRow(context,Icons.verified_user_rounded, 'Total Advisors', '28'),
              _infoRow(context,Icons.business_rounded, 'Companies', '156'),
              _infoRow(context,Icons.trending_up_rounded, 'Platform Revenue', '\u20B912.5L'),
            ]),
          ],
